...
function ViewVideo (props) {
    ...
    const activateQR = () => {
      ...
      let qrcodealt = new QrCodeWithLogo({
        canvas: document.querySelector('.viewvideo__main-questions-share-qr-code-alt'),
        content: window.location.href,
        width: 96,
        logo: {
          src: acumenLogo,
         ...
         {playStatus===true&&
          <div className="viewvideo__main-questions-share">
            ...
            <div className="viewvideo__main-questions-share-qr">
              ...
              <canvas className="viewvideo__main-questions-share-qr-code-alt" onLoad={()=>{activateQR()}}></canvas>
